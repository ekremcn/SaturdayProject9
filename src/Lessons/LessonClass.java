...
public abstract class LessonClass {
    ...
    public void setCreditCount() {
        ...
        while (totalCreditCount <= 7) {
            ...
            if (lessonsName.contains(question)) {
                System.out.println("You already took this class please choose other class");
            } else {
                lessonsName.add(question);
                totalCreditCount += checkCredit(question);
            }
        }
    }
    ...
    /*
     ...
     If the user took the class (you wrote in the console with the scanner class) is already exits in the arraylist and
     the user would like to take it again
